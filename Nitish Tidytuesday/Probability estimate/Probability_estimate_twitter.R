# Source of program https://github.com/othomantegazza/code-tidytuesday/blob/master/38-cetaceans.R
library(tidyverse)
library(lubridate)
library(rlang)
library(gtable)
...
dat_path <- "38-cetaceans.Rdata"
dat_url <- paste0("https://raw.githubusercontent.com/",
                  "rfordatascience/tidytuesday/master/data/2018/",
...
p_logit <- 
  ...
  labs(x = "Day of Acquisiton",
       y = "PROBABILITY\nthat new Cetacean\nwas NOT Captured",
       caption = "Sources: FOIA, Ceta-Base; collected by Amber Thomas | Plot by @nitishimtech")

p_logit

# save new plot with logistic regression
png(filename = "38-cetaceans-logit.png",
